...
* [PDF](http://honestcoyote.github.io/docs/first_nephi_edited.pdf)
* [Plain Text](http://honestcoyote.github.io/docs/first_nephi_edited.txt)

If this is your first time on this blog, please check out the [About page](http://honestcoyote.github.io/about/) for an overview of this project and the nature of the edits.

For First Nephi specifically, this is the first book of the Book of Mormon and is usually referred to as I Nephi, using the Roman numeral for one. However, "I, Nephi" is used frequently in the text when the narrator, Nephi, was saying or doing something. So, I thought it would be good to make a clear distinction between I Nephi and "I, Nephi". I'll continue with this slightly altered naming scheme for the rest of the project. 
...
If you disagree, or have any other comments, suggestions, criticisms, or (the always welcome) random compliments, please contact me at [pandaba@gmail.com](mailto:pandaba@gmail.com).